...
newDiv.style.color = "#ff6464";
document.body.appendChild(newDiv);
clone = newDiv.cloneNode(true);
document.body.appendChild(clone);

// Зробити ul в середині якої будуть лежати елементи масиву (кожен в своєму li)
let arrOne = ['Main', 'Products', 'About us', 'Contacts'];
let newUL = document.createElement("ul");
for (const newElement of arrOne) {
  let newLi = document.createElement("li");
  newLi.innerText = newElement;
...
for (const element of coursesAndDurationArray) {
  ...
  newParagraph.innerText = `${element.title} - ${element.monthDuration}`;
...
for (const simpson of simpsons) {
  ...
  let nameLi = document.createElement("li");
    nameLi.innerText = simpson.name;
  let surnameLi = document.createElement("li");
    surnameLi.innerText = simpson.surname;
  let ageLi = document.createElement("li");
    ageLi.innerText = simpson.age;
  let infoLi = document.createElement("li");
    infoLi.innerText = simpson.info;
                    // version with link to photo
                        // let photoLi = document.createElement("li");
                        // let photo=document.createElement("a");
                        // photo.setAttribute('href', simpson.photo);
...
//   let newDiv = document.createElement('div');
//   let fieldsOfElement =(object)=>Object.entries(coursesElement).map(([key,value])=>({[key]:value}));
//   let arr =fieldsOfElement(coursesElement);
//   arr.forEach(function (i,div) {
//     $(this).html()
//
//   })
  // for (const arrElement of arr) {
  //   let newDivEl = document.createElement('div');
  //   newDivEl.innerText=arrElement;
